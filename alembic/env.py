"""Alembic async environment configuration for Stonkmarket.

This env.py is configured for async PostgreSQL migrations using asyncpg.
It supports both online (connected) and offline (generate SQL) modes.
"""
