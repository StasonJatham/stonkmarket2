"""add_quant_scores_table

Revision ID: 6dd8bada218c
Revises: 03f1932d845a
Create Date: 2025-12-28 17:42:18.513532+00:00
...
revision: str = "6dd8bada218c"
down_revision: Union[str, None] = "03f1932d845a"
...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("best_score", sa.Numeric(precision=6, scale=2), nullable=False),
        sa.Column("mode", sa.String(length=20), nullable=False),
        sa.Column("score_a", sa.Numeric(precision=6, scale=2), nullable=True),
        sa.Column("score_b", sa.Numeric(precision=6, scale=2), nullable=True),
        sa.Column("gate_pass", sa.Boolean(), nullable=False),
        sa.Column("p_outperf", sa.Numeric(precision=6, scale=4), nullable=True),
        sa.Column("ci_low", sa.Numeric(precision=10, scale=4), nullable=True),
        sa.Column("ci_high", sa.Numeric(precision=10, scale=4), nullable=True),
        sa.Column("dsr", sa.Numeric(precision=6, scale=4), nullable=True),
        sa.Column("median_edge", sa.Numeric(precision=10, scale=4), nullable=True),
        sa.Column("edge_vs_stock", sa.Numeric(precision=10, scale=4), nullable=True),
        sa.Column("edge_vs_spy", sa.Numeric(precision=10, scale=4), nullable=True),
        sa.Column("worst_regime_edge", sa.Numeric(precision=10, scale=4), nullable=True),
        sa.Column("cvar_5", sa.Numeric(precision=10, scale=4), nullable=True),
        sa.Column("fund_mom", sa.Numeric(precision=6, scale=4), nullable=True),
        sa.Column("val_z", sa.Numeric(precision=6, scale=4), nullable=True),
        sa.Column("event_risk", sa.Boolean(), nullable=False),
        sa.Column("p_recovery", sa.Numeric(precision=6, scale=4), nullable=True),
        sa.Column("expected_value", sa.Numeric(precision=10, scale=4), nullable=True),
        sa.Column("sector_relative", sa.Numeric(precision=6, scale=4), nullable=True),
        ...
        sa.PrimaryKeyConstraint("id", name=op.f("pk_quant_scores")),
    )
    op.create_index(
    ...
    op.create_index(
        "idx_quant_scores_latest",
        "quant_scores",
        ["symbol", "computed_at"],
        unique=False,
        postgresql_using="btree",
    )
    op.create_index("idx_quant_scores_symbol", "quant_scores", ["symbol"], unique=False)
    op.create_index(
        "idx_quant_scores_symbol_date", "quant_scores", ["symbol", "computed_at"], unique=False
    )
...
def downgrade() -> None:
    ...
    op.drop_index("idx_quant_scores_symbol_date", table_name="quant_scores")
    op.drop_index("idx_quant_scores_symbol", table_name="quant_scores")
    op.drop_index("idx_quant_scores_latest", table_name="quant_scores", postgresql_using="btree")
    op.drop_index(
        "idx_quant_scores_best_score",
