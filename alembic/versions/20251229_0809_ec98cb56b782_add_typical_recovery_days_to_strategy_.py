"""add_typical_recovery_days_to_strategy_signals

Revision ID: ec98cb56b782
Revises: 941e2641ac7f
Create Date: 2025-12-29 08:09:25.964114+00:00
...
revision: str = "ec98cb56b782"
down_revision: Union[str, None] = "941e2641ac7f"
...
def upgrade() -> None:
    ...
    op.add_column(
        "strategy_signals", sa.Column("typical_recovery_days", sa.Integer(), nullable=True)
    )
...
def downgrade() -> None:
    ...
    op.drop_column("strategy_signals", "typical_recovery_days")
    op.drop_index(
        "idx_suggestions_score",
