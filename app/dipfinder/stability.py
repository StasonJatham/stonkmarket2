...
class StabilityMetrics:
    ...
    def to_dict(self) -> dict:
        ...
        return {
            ...
            "volatility_252d": round(self.volatility_252d, 4) if self.volatility_252d is not None else None,
            "max_drawdown_5y": round(self.max_drawdown_5y, 4) if self.max_drawdown_5y is not None else None,
            "typical_dip_365": round(self.typical_dip_365, 4) if self.typical_dip_365 is not None else None,
