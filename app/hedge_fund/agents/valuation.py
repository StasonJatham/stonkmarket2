...
class ValuationAgent(CalculationAgentBase):
    ...
    def _calculate_dcf(self, f: Fundamentals) -> float | None:
    ...
    def _calculate_owner_earnings(self, f: Fundamentals) -> float | None:
        """
...
# Singleton
_valuation_agent: ValuationAgent | None = None
