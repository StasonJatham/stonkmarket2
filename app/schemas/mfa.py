...
class MFAVerifyResponse(BaseModel):
    ...
    enabled: bool
    backup_codes: List[str] = Field(..., description="One-time backup codes (show once, user must save)")
...
class MFAValidateResponse(BaseModel):
    ...
    valid: bool
    mfa_token: Optional[str] = Field(None, description="Short-lived token for subsequent MFA-protected operations")
