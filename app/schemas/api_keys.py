...
class ApiKeyCreate(BaseModel):
    ...
    key_name: str = Field(..., min_length=1, max_length=100, description="Unique key identifier")
    api_key: str = Field(..., min_length=10, description="The API key value")
    mfa_code: str = Field(..., min_length=6, max_length=8, description="MFA code for verification")
...
class ApiKeyResponse(BaseModel):
    ...
    id: int
    key_name: str
    key_hint: Optional[str] = Field(None, description="Partial key hint like 'sk-...abc1'")
    created_at: str
    updated_at: str
    created_by: str
